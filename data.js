...
//         <Routes>
//           {/* Redirect the base path */}
//           <Route path="/" element={<Navigate to="/student-dashboard" replace />} />
          
//           {/* Admin Dashboard Routes */}
//           <Route path="/dashboard" element={<Dashboard />}>
//             <Route index element={<Navigate to="/dashboard/class" replace />} />
...
//             <Route index element={<Navigate to="/student-dashboard/class" replace />} />
...
//             <Route index element={<Navigate to="/teacher-dashboard/class" replace />} />
